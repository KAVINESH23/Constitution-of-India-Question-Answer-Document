...
def vector_embedding():
     if "vectors" not in st.session_state:
        ...
        st.session_state.loader=PyPDFDirectoryLoader("law enforcement") ## Data Ingestion
        st.session_state.docs=st.session_state.loader.load() ## Document Loading
        st.session_state.text_splitter=RecursiveCharacterTextSplitter(chunk_size=9000,chunk_overlap=2000) ## Chunk Creation
